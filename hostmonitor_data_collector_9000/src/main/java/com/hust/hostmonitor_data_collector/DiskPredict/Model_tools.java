...
public class Model_tools {
	...
	public final static String PATH_ROOT = System.getProperty("user.dir") + "/DiskPredictData/V_2.0/";
	public final static String PATH_MODEL = "models/";
	public final static String PATH_CONFIG = "conf/";
	public static String PATH_INPUT = System.getProperty("user.dir") + "/DiskPredictData/input/testInput.csv";
	public static String PATH_OUTPUT = System.getProperty("user.dir") + "/DiskPredictData/output/testOutput.csv";
	// 固有名称
	...
	public final static String[] CONFIG_FILES = { "firmware.conf", "norm.conf", "RandomForestClassifier.conf", "transmodel.conf" };
