...
public class OSHISampler implements Sampler{
    ...
    public void hardWareSample(){
        ...
        dataObject.put("allDiskTotalSize",FormatUtils.doubleTo2bits_double(totalsize*1.0/1024/1024/1024));
    ...
    public static void main(String[] args) {
       String test ="/dev/sda1";
       System.out.println(test.split("/")[2].substring(0,3));
    }
}
